...
(function (G2W) {
    ...
    (function (CustomDialogs) {
        ...
        })(CustomDialogs.CustomDialogType || (CustomDialogs.CustomDialogType = {}));
        var CustomDialogType = CustomDialogs.CustomDialogType;
    ...
    })(G2W.CustomDialogs || (G2W.CustomDialogs = {}));
    var CustomDialogs = G2W.CustomDialogs;
})(G2W || (G2W = {}));
var G2W;
(function (G2W) {
...
(function (G2W) {
    var Exporter = (function () {
        function Exporter() {
            ...
            this.HOST_URL = "http://huntedcow.cachefly.net/fs";
            this.TILE_URL = this.HOST_URL + "/tiles/%set%_%tile%.gif";
            this.LOCATION_URL = this.HOST_URL + "/locations/%tile%.gif";
            this.STAIR_URL = this.HOST_URL + "/stairways/%tile%.gif";
            this.RELIC_URL = this.HOST_URL + "/relics/%tile%.gif";
            this.PORTAL_URL = this.HOST_URL + "/portals/%tile%.gif";
            this.SHOP_URL = this.HOST_URL + "/shops/%tile%.gif";
        }
...
(function (G2W) {
    (function (Data) {
        ...
        })(Data.MapLocationType || (Data.MapLocationType = {}));
        var MapLocationType = Data.MapLocationType;
        ...
        var MapLayout = (function () {
            ...
            MapLayout.prototype.generateMap = function () {
                if (this.generatedMap == undefined) {
                    var table = document.createElement("table"), urlHost = "http://huntedcow.cachefly.net/fs", tileUrl = urlHost + "/tiles/%set%_%tile%.gif", locationUrl = urlHost + "/locations/%tile%.gif", stairUrl = urlHost + "/stairways/%tile%.gif", relicUrl = urlHost + "/relics/%tile%.gif", portalUrl = urlHost + "/portals/%tile%.gif", shopsUrl = urlHost + "/shops/%tile%.gif";
